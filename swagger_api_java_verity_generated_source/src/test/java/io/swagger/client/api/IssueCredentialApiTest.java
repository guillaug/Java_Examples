...
/**
 * API tests for IssueCredentialApi
 */
@Ignore
public class IssueCredentialApiTest {

    private final IssueCredentialApi api = new IssueCredentialApi();
     ...
     */
    @Test
    public void getIssueCredentialStatusTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        String forRelationship = null;
        String familyQualifier = null;
        String msgName = null;
        IssueCredentialStatusReport response = api.getIssueCredentialStatus(domainDID, threadId, forRelationship, familyQualifier, msgName);
     ...
     */
    @Test
    public void issueCredentialTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        Body1 body = null;
        PostResponse response = api.issueCredential(domainDID, threadId, body);
