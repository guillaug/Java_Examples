...
/**
 * API tests for WriteSchemaApi
 */
@Ignore
public class WriteSchemaApiTest {

    private final WriteSchemaApi api = new WriteSchemaApi();
     ...
     */
    @Test
    public void writeSchemaTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        WriteSchemaRequest body = null;
        PostResponse response = api.writeSchema(domainDID, threadId, body);
