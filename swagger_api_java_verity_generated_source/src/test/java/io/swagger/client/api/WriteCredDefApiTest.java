...
/**
 * API tests for WriteCredDefApi
 */
@Ignore
public class WriteCredDefApiTest {

    private final WriteCredDefApi api = new WriteCredDefApi();
     ...
     */
    @Test
    public void writeCredDefTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        WriteCredDefRequest body = null;
        PostResponse response = api.writeCredDef(domainDID, threadId, body);
