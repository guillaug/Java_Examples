...
/**
 * API tests for CommittedAnswerApi
 */
@Ignore
public class CommittedAnswerApiTest {

    private final CommittedAnswerApi api = new CommittedAnswerApi();
     ...
     */
    @Test
    public void getCommittedAnswerStatusTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        String forRelationship = null;
        String familyQualifier = null;
        QuestionStatusReport response = api.getCommittedAnswerStatus(domainDID, threadId, forRelationship, familyQualifier);
     ...
     */
    @Test
    public void questionTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        AskQuestion body = null;
        PostResponse response = api.question(domainDID, threadId, body);
