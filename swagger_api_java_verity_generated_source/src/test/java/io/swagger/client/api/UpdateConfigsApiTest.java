...
/**
 * API tests for UpdateConfigsApi
 */
@Ignore
public class UpdateConfigsApiTest {

    private final UpdateConfigsApi api = new UpdateConfigsApi();
     ...
     */
    @Test
    public void updateConfigsTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        UpdateConfigsRequest body = null;
        PostResponse response = api.updateConfigs(domainDID, threadId, body);
