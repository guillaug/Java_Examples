...
/**
 * API tests for UpdateEndpointApi
 */
@Ignore
public class UpdateEndpointApiTest {

    private final UpdateEndpointApi api = new UpdateEndpointApi();
    ...
    public void updateEndpointTest() throws ApiException {
        ...
        UpdateEndpoint body = null;
        PostResponse response = api.updateEndpoint(domainDID, body);
