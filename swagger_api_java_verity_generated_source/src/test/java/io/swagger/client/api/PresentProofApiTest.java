...
/**
 * API tests for PresentProofApi
 */
@Ignore
public class PresentProofApiTest {

    private final PresentProofApi api = new PresentProofApi();
     ...
     */
    @Test
    public void getPresentProofStatusTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        String forRelationship = null;
        String familyQualifier = null;
        String msgName = null;
        PresentProofStatusReport response = api.getPresentProofStatus(domainDID, threadId, forRelationship, familyQualifier, msgName);
     ...
     */
    @Test
    public void requestProofTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        Body2 body = null;
        PostResponse response = api.requestProof(domainDID, threadId, body);
