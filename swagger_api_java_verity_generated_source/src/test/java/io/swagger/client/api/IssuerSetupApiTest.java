...
/**
 * API tests for IssuerSetupApi
 */
@Ignore
public class IssuerSetupApiTest {

    private final IssuerSetupApi api = new IssuerSetupApi();
     ...
     */
    @Test
    public void apiDomainDIDIssuerSetup06ThreadIdPostTest() throws ApiException {
        String domainDID = null;
        UUID threadId = null;
        Body3 body = null;
        PostResponse response = api.apiDomainDIDIssuerSetup06ThreadIdPost(domainDID, threadId, body);
