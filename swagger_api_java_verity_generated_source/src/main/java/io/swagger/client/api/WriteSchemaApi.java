...
import io.swagger.client.model.WriteSchemaRequest;
...
public class WriteSchemaApi {
    private ApiClient apiClient;

    public WriteSchemaApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WriteSchemaApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call writeSchemaCall(String domainDID, UUID threadId, WriteSchemaRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/{domainDID}/write-schema/0.6/{threadId}"
    ...
    private com.squareup.okhttp.Call writeSchemaValidateBeforeCall(String domainDID, UUID threadId, WriteSchemaRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling writeSchema(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling writeSchema(Async)");
        }
        
        com.squareup.okhttp.Call call = writeSchemaCall(domainDID, threadId, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PostResponse writeSchema(String domainDID, UUID threadId, WriteSchemaRequest body) throws ApiException {
        ApiResponse<PostResponse> resp = writeSchemaWithHttpInfo(domainDID, threadId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> writeSchemaWithHttpInfo(String domainDID, UUID threadId, WriteSchemaRequest body) throws ApiException {
        com.squareup.okhttp.Call call = writeSchemaValidateBeforeCall(domainDID, threadId, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call writeSchemaAsync(String domainDID, UUID threadId, WriteSchemaRequest body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = writeSchemaValidateBeforeCall(domainDID, threadId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
