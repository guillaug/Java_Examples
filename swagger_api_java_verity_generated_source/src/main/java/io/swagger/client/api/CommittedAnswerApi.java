...
import io.swagger.client.model.AskQuestion;
import io.swagger.client.model.PostResponse;
import io.swagger.client.model.QuestionStatusReport;
...
public class CommittedAnswerApi {
    ...
    public CommittedAnswerApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getCommittedAnswerStatus
     * @param domainDID  (required)
     * @param threadId  (required)
     * @param forRelationship DID returned from CreateRelationship (required)
     ...
     */
    public com.squareup.okhttp.Call getCommittedAnswerStatusCall(String domainDID, UUID threadId, String forRelationship, String familyQualifier, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/api/{domainDID}/committedanswer/1.0/{threadId}"
    ...
    private com.squareup.okhttp.Call getCommittedAnswerStatusValidateBeforeCall(String domainDID, UUID threadId, String forRelationship, String familyQualifier, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling getCommittedAnswerStatus(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling getCommittedAnswerStatus(Async)");
        }
        // verify the required parameter 'forRelationship' is set
        if (forRelationship == null) {
            throw new ApiException("Missing the required parameter 'forRelationship' when calling getCommittedAnswerStatus(Async)");
        }
        // verify the required parameter 'familyQualifier' is set
        if (familyQualifier == null) {
            throw new ApiException("Missing the required parameter 'familyQualifier' when calling getCommittedAnswerStatus(Async)");
        }
        
        com.squareup.okhttp.Call call = getCommittedAnswerStatusCall(domainDID, threadId, forRelationship, familyQualifier, progressListener, progressRequestListener);
        return call;
     ...
     * @param forRelationship DID returned from CreateRelationship (required)
     * @param familyQualifier msg family qualifier (required)
     * @return QuestionStatusReport
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public QuestionStatusReport getCommittedAnswerStatus(String domainDID, UUID threadId, String forRelationship, String familyQualifier) throws ApiException {
        ApiResponse<QuestionStatusReport> resp = getCommittedAnswerStatusWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier);
        return resp.getData();
    }
     ...
     * @param forRelationship DID returned from CreateRelationship (required)
     * @param familyQualifier msg family qualifier (required)
     * @return ApiResponse&lt;QuestionStatusReport&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<QuestionStatusReport> getCommittedAnswerStatusWithHttpInfo(String domainDID, UUID threadId, String forRelationship, String familyQualifier) throws ApiException {
        com.squareup.okhttp.Call call = getCommittedAnswerStatusValidateBeforeCall(domainDID, threadId, forRelationship, familyQualifier, null, null);
        Type localVarReturnType = new TypeToken<QuestionStatusReport>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getCommittedAnswerStatusAsync(String domainDID, UUID threadId, String forRelationship, String familyQualifier, final ApiCallback<QuestionStatusReport> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getCommittedAnswerStatusValidateBeforeCall(domainDID, threadId, forRelationship, familyQualifier, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<QuestionStatusReport>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for question
     * @param domainDID  (required)
     * @param threadId  (required)
     * @param body  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call questionCall(String domainDID, UUID threadId, AskQuestion body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call questionValidateBeforeCall(String domainDID, UUID threadId, AskQuestion body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling question(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling question(Async)");
        }
        
        com.squareup.okhttp.Call call = questionCall(domainDID, threadId, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PostResponse question(String domainDID, UUID threadId, AskQuestion body) throws ApiException {
        ApiResponse<PostResponse> resp = questionWithHttpInfo(domainDID, threadId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> questionWithHttpInfo(String domainDID, UUID threadId, AskQuestion body) throws ApiException {
        com.squareup.okhttp.Call call = questionValidateBeforeCall(domainDID, threadId, body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call questionAsync(String domainDID, UUID threadId, AskQuestion body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = questionValidateBeforeCall(domainDID, threadId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
