...
import io.swagger.client.model.UpdateEndpoint;
...
public class UpdateEndpointApi {
    private ApiClient apiClient;

    public UpdateEndpointApi() {
        this(Configuration.getDefaultApiClient());
    }

    public UpdateEndpointApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call updateEndpointCall(String domainDID, UpdateEndpoint body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/{domainDID}/configs/0.6/"
    ...
    private com.squareup.okhttp.Call updateEndpointValidateBeforeCall(String domainDID, UpdateEndpoint body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling updateEndpoint(Async)");
        }
        
        com.squareup.okhttp.Call call = updateEndpointCall(domainDID, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PostResponse updateEndpoint(String domainDID, UpdateEndpoint body) throws ApiException {
        ApiResponse<PostResponse> resp = updateEndpointWithHttpInfo(domainDID, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> updateEndpointWithHttpInfo(String domainDID, UpdateEndpoint body) throws ApiException {
        com.squareup.okhttp.Call call = updateEndpointValidateBeforeCall(domainDID, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call updateEndpointAsync(String domainDID, UpdateEndpoint body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateEndpointValidateBeforeCall(domainDID, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
