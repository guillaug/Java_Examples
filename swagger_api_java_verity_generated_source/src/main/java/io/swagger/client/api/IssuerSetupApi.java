...
public class IssuerSetupApi {
    ...
    public IssuerSetupApi(ApiClient apiClient) {
    ...
    /**
     * Build call for apiDomainDIDIssuerSetup06ThreadIdPost
     ...
     */
    public com.squareup.okhttp.Call apiDomainDIDIssuerSetup06ThreadIdPostCall(String domainDID, UUID threadId, Body3 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/{domainDID}/issuer-setup/0.6/{threadId}"
    ...
    private com.squareup.okhttp.Call apiDomainDIDIssuerSetup06ThreadIdPostValidateBeforeCall(String domainDID, UUID threadId, Body3 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling apiDomainDIDIssuerSetup06ThreadIdPost(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling apiDomainDIDIssuerSetup06ThreadIdPost(Async)");
        }
        
        com.squareup.okhttp.Call call = apiDomainDIDIssuerSetup06ThreadIdPostCall(domainDID, threadId, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PostResponse apiDomainDIDIssuerSetup06ThreadIdPost(String domainDID, UUID threadId, Body3 body) throws ApiException {
        ApiResponse<PostResponse> resp = apiDomainDIDIssuerSetup06ThreadIdPostWithHttpInfo(domainDID, threadId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> apiDomainDIDIssuerSetup06ThreadIdPostWithHttpInfo(String domainDID, UUID threadId, Body3 body) throws ApiException {
        com.squareup.okhttp.Call call = apiDomainDIDIssuerSetup06ThreadIdPostValidateBeforeCall(domainDID, threadId, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call apiDomainDIDIssuerSetup06ThreadIdPostAsync(String domainDID, UUID threadId, Body3 body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = apiDomainDIDIssuerSetup06ThreadIdPostValidateBeforeCall(domainDID, threadId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
