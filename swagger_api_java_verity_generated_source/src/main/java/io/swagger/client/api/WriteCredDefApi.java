...
import io.swagger.client.model.WriteCredDefRequest;
...
public class WriteCredDefApi {
    private ApiClient apiClient;

    public WriteCredDefApi() {
        this(Configuration.getDefaultApiClient());
    }

    public WriteCredDefApi(ApiClient apiClient) {
     ...
     */
    public com.squareup.okhttp.Call writeCredDefCall(String domainDID, UUID threadId, WriteCredDefRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = body;
        
        // create path and map variables
        String localVarPath = "/api/{domainDID}/write-cred-def/0.6/{threadId}"
    ...
    private com.squareup.okhttp.Call writeCredDefValidateBeforeCall(String domainDID, UUID threadId, WriteCredDefRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling writeCredDef(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling writeCredDef(Async)");
        }
        
        com.squareup.okhttp.Call call = writeCredDefCall(domainDID, threadId, body, progressListener, progressRequestListener);
        return call;
     ...
     */
    public PostResponse writeCredDef(String domainDID, UUID threadId, WriteCredDefRequest body) throws ApiException {
        ApiResponse<PostResponse> resp = writeCredDefWithHttpInfo(domainDID, threadId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> writeCredDefWithHttpInfo(String domainDID, UUID threadId, WriteCredDefRequest body) throws ApiException {
        com.squareup.okhttp.Call call = writeCredDefValidateBeforeCall(domainDID, threadId, body, null, null);
     ...
     */
    public com.squareup.okhttp.Call writeCredDefAsync(String domainDID, UUID threadId, WriteCredDefRequest body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = writeCredDefValidateBeforeCall(domainDID, threadId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
