...
import io.swagger.client.model.IssueCredentialStatusReport;
...
public class IssueCredentialApi {
    private ApiClient apiClient;

    public IssueCredentialApi() {
        this(Configuration.getDefaultApiClient());
    }

    public IssueCredentialApi(ApiClient apiClient) {
    ...
    /**
     * Build call for getIssueCredentialStatus
    ...
    private com.squareup.okhttp.Call getIssueCredentialStatusValidateBeforeCall(String domainDID, UUID threadId, String forRelationship, String familyQualifier, String msgName, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling getIssueCredentialStatus(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling getIssueCredentialStatus(Async)");
        }
        // verify the required parameter 'forRelationship' is set
        if (forRelationship == null) {
            throw new ApiException("Missing the required parameter 'forRelationship' when calling getIssueCredentialStatus(Async)");
        }
        // verify the required parameter 'familyQualifier' is set
        if (familyQualifier == null) {
            throw new ApiException("Missing the required parameter 'familyQualifier' when calling getIssueCredentialStatus(Async)");
        }
        // verify the required parameter 'msgName' is set
        if (msgName == null) {
            throw new ApiException("Missing the required parameter 'msgName' when calling getIssueCredentialStatus(Async)");
        }
        
        com.squareup.okhttp.Call call = getIssueCredentialStatusCall(domainDID, threadId, forRelationship, familyQualifier, msgName, progressListener, progressRequestListener);
        return call;
     ...
     * @param familyQualifier msg family qualifier (required)
     * @param msgName msg name (required)
     * @return IssueCredentialStatusReport
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public IssueCredentialStatusReport getIssueCredentialStatus(String domainDID, UUID threadId, String forRelationship, String familyQualifier, String msgName) throws ApiException {
        ApiResponse<IssueCredentialStatusReport> resp = getIssueCredentialStatusWithHttpInfo(domainDID, threadId, forRelationship, familyQualifier, msgName);
        return resp.getData();
    }
     ...
     * @param familyQualifier msg family qualifier (required)
     * @param msgName msg name (required)
     * @return ApiResponse&lt;IssueCredentialStatusReport&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<IssueCredentialStatusReport> getIssueCredentialStatusWithHttpInfo(String domainDID, UUID threadId, String forRelationship, String familyQualifier, String msgName) throws ApiException {
        com.squareup.okhttp.Call call = getIssueCredentialStatusValidateBeforeCall(domainDID, threadId, forRelationship, familyQualifier, msgName, null, null);
        Type localVarReturnType = new TypeToken<IssueCredentialStatusReport>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getIssueCredentialStatusAsync(String domainDID, UUID threadId, String forRelationship, String familyQualifier, String msgName, final ApiCallback<IssueCredentialStatusReport> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getIssueCredentialStatusValidateBeforeCall(domainDID, threadId, forRelationship, familyQualifier, msgName, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<IssueCredentialStatusReport>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
    /**
     * Build call for issueCredential
     * @param domainDID  (required)
     * @param threadId  (required)
     * @param body  (optional)
     * @param progressListener Progress listener
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call issueCredentialCall(String domainDID, UUID threadId, Body1 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call issueCredentialValidateBeforeCall(String domainDID, UUID threadId, Body1 body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'domainDID' is set
        if (domainDID == null) {
            throw new ApiException("Missing the required parameter 'domainDID' when calling issueCredential(Async)");
        }
        // verify the required parameter 'threadId' is set
        if (threadId == null) {
            throw new ApiException("Missing the required parameter 'threadId' when calling issueCredential(Async)");
        }
        
        com.squareup.okhttp.Call call = issueCredentialCall(domainDID, threadId, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public PostResponse issueCredential(String domainDID, UUID threadId, Body1 body) throws ApiException {
        ApiResponse<PostResponse> resp = issueCredentialWithHttpInfo(domainDID, threadId, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<PostResponse> issueCredentialWithHttpInfo(String domainDID, UUID threadId, Body1 body) throws ApiException {
        com.squareup.okhttp.Call call = issueCredentialValidateBeforeCall(domainDID, threadId, body, null, null);
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call issueCredentialAsync(String domainDID, UUID threadId, Body1 body, final ApiCallback<PostResponse> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = issueCredentialValidateBeforeCall(domainDID, threadId, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<PostResponse>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
