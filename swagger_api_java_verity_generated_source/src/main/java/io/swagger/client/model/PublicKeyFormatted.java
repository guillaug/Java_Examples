...
public class PublicKeyFormatted {
  @SerializedName("id")
  ...
  public PublicKeyFormatted id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public PublicKeyFormatted type(String type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(example = "Ed25519VerificationKey2018", required = true, description = "")
  ...
  public PublicKeyFormatted controller(String controller) {
   ...
   * @return controller
  **/
  @Schema(example = "VsMfDe92kv62X4S6VLpndj", required = true, description = "")
  ...
  public PublicKeyFormatted publicKeyBase58(String publicKeyBase58) {
  ...
  **/
  @Schema(example = "GjahbXpWVQrcygSidE6diBmqMdQUb6S2PKbjdimF7s4f", required = true, description = "verkey")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PublicKeyFormatted publicKeyFormatted = (PublicKeyFormatted) o;
    return Objects.equals(this.id, publicKeyFormatted.id) &&
        Objects.equals(this.type, publicKeyFormatted.type) &&
        Objects.equals(this.controller, publicKeyFormatted.controller) &&
        Objects.equals(this.publicKeyBase58, publicKeyFormatted.publicKeyBase58);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, type, controller, publicKeyBase58);
  }
