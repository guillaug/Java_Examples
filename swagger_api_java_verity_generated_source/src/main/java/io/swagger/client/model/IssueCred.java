...
public class IssueCred implements OneOfSentIssueCredMsgMsg {
  @SerializedName("credentials~attach")
  private List<EmbeddingAttachment> credentialsattach = null;
  ...
  public IssueCred credentialsattach(List<EmbeddingAttachment> credentialsattach) {
    this.credentialsattach = credentialsattach;
    return this;
  }

  public IssueCred addCredentialsattachItem(EmbeddingAttachment credentialsattachItem) {
    if (this.credentialsattach == null) {
      this.credentialsattach = new ArrayList<EmbeddingAttachment>();
    }
    this.credentialsattach.add(credentialsattachItem);
    return this;
  }

   /**
   * Get credentialsattach
   * @return credentialsattach
  **/
  @Schema(description = "")
  public List<EmbeddingAttachment> getCredentialsattach() {
    return credentialsattach;
  }

  public void setCredentialsattach(List<EmbeddingAttachment> credentialsattach) {
    this.credentialsattach = credentialsattach;
  }

  public IssueCred comment(String comment) {
  ...
  **/
  ...
  public IssueCred pleaseAck(PleaseAck pleaseAck) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IssueCred issueCred = (IssueCred) o;
    return Objects.equals(this.credentialsattach, issueCred.credentialsattach) &&
        Objects.equals(this.comment, issueCred.comment) &&
        Objects.equals(this.pleaseAck, issueCred.pleaseAck);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credentialsattach, comment, pleaseAck);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCred {\n");
    
    sb.append("    credentialsattach: ").append(toIndentedString(credentialsattach)).append("\n");
