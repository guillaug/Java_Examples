...
public class WriteCredDefResponse {
  @SerializedName("@type")
  ...
  public WriteCredDefResponse _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:123456789abcdefghi1234;spec/write-cred-def/0.6/status-report", required = true, description = "")
  ...
  public WriteCredDefResponse thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public WriteCredDefResponse credDefId(String credDefId) {
   ...
   * @return credDefId
  **/
  @Schema(example = "39YBdt6BLWLJAUPA8NvwDX:3:CL:55:tag", required = true, description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WriteCredDefResponse writeCredDefResponse = (WriteCredDefResponse) o;
    return Objects.equals(this._atType, writeCredDefResponse._atType) &&
        Objects.equals(this.thread, writeCredDefResponse.thread) &&
        Objects.equals(this.credDefId, writeCredDefResponse.credDefId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, thread, credDefId);
  }
