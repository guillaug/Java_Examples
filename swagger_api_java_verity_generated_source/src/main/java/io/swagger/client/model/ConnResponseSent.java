...
import io.swagger.client.model.ConnResponseMsg;
...
public class ConnResponseSent {
  ...
  @SerializedName("resp")
  private ConnResponseMsg resp = null;

  public ConnResponseSent _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/connections/1.0/response-sent", required = true, description = "")
  ...
  public ConnResponseSent _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public ConnResponseSent thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public ConnResponseSent myDID(String myDID) {
    this.myDID = myDID;
    return this;
  }
   ...
   * @return myDID
  **/
  @Schema(example = "JLzQCiPDhiun7XWzh4rn11", required = true, description = "")
  ...
  public ConnResponseSent resp(ConnResponseMsg resp) {
    this.resp = resp;
    return this;
  }
  ...
  **/
  @Schema(required = true, description = "")
  public ConnResponseMsg getResp() {
    return resp;
  }

  public void setResp(ConnResponseMsg resp) {
    this.resp = resp;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConnResponseSent connResponseSent = (ConnResponseSent) o;
    return Objects.equals(this._atType, connResponseSent._atType) &&
        Objects.equals(this._atId, connResponseSent._atId) &&
        Objects.equals(this.thread, connResponseSent.thread) &&
        Objects.equals(this.myDID, connResponseSent.myDID) &&
        Objects.equals(this.resp, connResponseSent.resp);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread, myDID, resp);
  }
  ...
  public String toString() {
    ...
    sb.append("class ConnResponseSent {\n");
