...
public class CurrentPublicIdentifier implements OneOfbody3 {
  @SerializedName("@type")
  private String _atType = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/current-public-identifier";

  @SerializedName("@id")
  private UUID _atId = null;

  public CurrentPublicIdentifier _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:123456789abcdefghi1234;spec/issuer-setup/0.6/current-public-identifier", description = "")
  ...
  public CurrentPublicIdentifier _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CurrentPublicIdentifier currentPublicIdentifier = (CurrentPublicIdentifier) o;
    return Objects.equals(this._atType, currentPublicIdentifier._atType) &&
        Objects.equals(this._atId, currentPublicIdentifier._atId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId);
  }
  ...
  public String toString() {
    ...
    sb.append("class CurrentPublicIdentifier {\n");
