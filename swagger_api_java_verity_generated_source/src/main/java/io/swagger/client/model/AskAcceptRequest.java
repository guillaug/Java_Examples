...
public class AskAcceptRequest {
  @SerializedName("comment")
  private String comment = null;

  @SerializedName("requests~attach")
  private List<EmbeddingAttachment> requestsattach = null;

  public AskAcceptRequest comment(String comment) {
  ...
  **/
  ...
  public AskAcceptRequest requestsattach(List<EmbeddingAttachment> requestsattach) {
    this.requestsattach = requestsattach;
    return this;
  }

  public AskAcceptRequest addRequestsattachItem(EmbeddingAttachment requestsattachItem) {
    if (this.requestsattach == null) {
      this.requestsattach = new ArrayList<EmbeddingAttachment>();
    }
    this.requestsattach.add(requestsattachItem);
    return this;
  }
  ...
  **/
  @Schema(description = "")
  public List<EmbeddingAttachment> getRequestsattach() {
    return requestsattach;
  }

  public void setRequestsattach(List<EmbeddingAttachment> requestsattach) {
    this.requestsattach = requestsattach;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AskAcceptRequest askAcceptRequest = (AskAcceptRequest) o;
    return Objects.equals(this.comment, askAcceptRequest.comment) &&
        Objects.equals(this.requestsattach, askAcceptRequest.requestsattach);
  }

  @Override
  public int hashCode() {
    return Objects.hash(comment, requestsattach);
  }
  ...
  public String toString() {
    ...
    sb.append("class AskAcceptRequest {\n");
    
    sb.append("    comment: ").append(toIndentedString(comment)).append("\n");
    sb.append("    requestsattach: ").append(toIndentedString(requestsattach)).append("\n");
    sb.append("}");
    return sb.toString();
  }
