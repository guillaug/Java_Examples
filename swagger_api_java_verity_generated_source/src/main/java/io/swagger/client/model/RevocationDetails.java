...
public class RevocationDetails {
  ...
  private Boolean supportRevocation = false;

  @SerializedName("tails_file")
  private String tailsFile = null;

  @SerializedName("max_creds")
  private Integer maxCreds = null;

  public RevocationDetails supportRevocation(Boolean supportRevocation) {
    this.supportRevocation = supportRevocation;
    return this;
  }

   /**
   * Get supportRevocation
   * @return supportRevocation
  **/
  @Schema(example = "false", description = "")
  public Boolean isSupportRevocation() {
    return supportRevocation;
  }
  ...
  public RevocationDetails tailsFile(String tailsFile) {
   ...
   * @return tailsFile
  **/
  @Schema(description = "required if `support_revocation` is true")
  public String getTailsFile() {
    return tailsFile;
  }

  public void setTailsFile(String tailsFile) {
    this.tailsFile = tailsFile;
  }

  public RevocationDetails maxCreds(Integer maxCreds) {
  ...
  **/
  @Schema(description = "required if `support_revocation` is true")
  public Integer getMaxCreds() {
    return maxCreds;
  }

  public void setMaxCreds(Integer maxCreds) {
    this.maxCreds = maxCreds;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.supportRevocation, revocationDetails.supportRevocation) &&
        Objects.equals(this.tailsFile, revocationDetails.tailsFile) &&
        Objects.equals(this.maxCreds, revocationDetails.maxCreds);
  }

  @Override
  public int hashCode() {
    return Objects.hash(supportRevocation, tailsFile, maxCreds);
  }
  ...
  public String toString() {
    ...
    sb.append("    tailsFile: ").append(toIndentedString(tailsFile)).append("\n");
    sb.append("    maxCreds: ").append(toIndentedString(maxCreds)).append("\n");
    sb.append("}");
    return sb.toString();
  }
