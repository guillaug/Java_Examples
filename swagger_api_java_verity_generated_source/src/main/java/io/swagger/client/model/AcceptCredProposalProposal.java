...
public class AcceptCredProposalProposal {
  @SerializedName("cred_def_id")
  private String credDefId = null;

  @SerializedName("credential_proposal")
  private CredPreview credentialProposal = null;

  @SerializedName("comment")
  private String comment = null;

  public AcceptCredProposalProposal credDefId(String credDefId) {
   ...
   * @return credDefId
  **/
  @Schema(example = "KwgzAuJxWTZMJwfN7pbX6P:3:CL:104:tag", description = "id of credential definition used")
  ...
  public AcceptCredProposalProposal credentialProposal(CredPreview credentialProposal) {
  ...
  **/
  @Schema(description = "")
  public CredPreview getCredentialProposal() {
    return credentialProposal;
  }

  public void setCredentialProposal(CredPreview credentialProposal) {
    this.credentialProposal = credentialProposal;
  }

  public AcceptCredProposalProposal comment(String comment) {
   ...
   * @return comment
  **/
  @Schema(example = "some comment", description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AcceptCredProposalProposal acceptCredProposalProposal = (AcceptCredProposalProposal) o;
    return Objects.equals(this.credDefId, acceptCredProposalProposal.credDefId) &&
        Objects.equals(this.credentialProposal, acceptCredProposalProposal.credentialProposal) &&
        Objects.equals(this.comment, acceptCredProposalProposal.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(credDefId, credentialProposal, comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class AcceptCredProposalProposal {\n");
