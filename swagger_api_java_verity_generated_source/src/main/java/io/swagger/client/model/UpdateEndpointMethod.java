...
import io.swagger.client.model.UpdateEndpointPackaging;
...
public class UpdateEndpointMethod {
  @SerializedName("id")
  private String id = "webhook";
  ...
  private UpdateEndpointPackaging packaging = null;

  public UpdateEndpointMethod id(String id) {
    this.id = id;
    return this;
  }
   ...
   * @return id
  **/
  @Schema(example = "webhook", description = "Webhook id")
  public String getId() {
    return id;
  }
  ...
  public UpdateEndpointMethod value(String value) {
    this.value = value;
    return this;
  }
   ...
   * @return value
  **/
  @Schema(example = "http://localhost:6001", description = "")
  ...
  public UpdateEndpointMethod type(Integer type) {
    this.type = type;
    return this;
  }
   ...
   * @return type
  **/
  @Schema(example = "2", description = "Webhook type")
  ...
  public UpdateEndpointMethod packaging(UpdateEndpointPackaging packaging) {
  ...
  **/
  @Schema(description = "")
  public UpdateEndpointPackaging getPackaging() {
    return packaging;
  }

  public void setPackaging(UpdateEndpointPackaging packaging) {
    this.packaging = packaging;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateEndpointMethod updateEndpointMethod = (UpdateEndpointMethod) o;
    return Objects.equals(this.id, updateEndpointMethod.id) &&
        Objects.equals(this.value, updateEndpointMethod.value) &&
        Objects.equals(this.type, updateEndpointMethod.type) &&
        Objects.equals(this.packaging, updateEndpointMethod.packaging);
  }

  @Override
  public int hashCode() {
    return Objects.hash(id, value, type, packaging);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateEndpointMethod {\n");
