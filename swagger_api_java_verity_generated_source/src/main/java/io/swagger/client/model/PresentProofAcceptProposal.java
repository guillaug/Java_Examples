...
public class PresentProofAcceptProposal implements OneOfbody2 {
  @SerializedName("@type")
  ...
  public PresentProofAcceptProposal _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/request", description = "")
  ...
  public PresentProofAcceptProposal _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public PresentProofAcceptProposal forRelationship(String forRelationship) {
  ...
  **/
  @Schema(example = "3kDecNDa33qAsFv5Th7juC", description = "")
  ...
  public PresentProofAcceptProposal name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "proof-request-1", description = "name of proof")
  ...
  public PresentProofAcceptProposal revocationInterval(RevocationInterval revocationInterval) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    PresentProofAcceptProposal presentProofAcceptProposal = (PresentProofAcceptProposal) o;
    return Objects.equals(this._atType, presentProofAcceptProposal._atType) &&
        Objects.equals(this._atId, presentProofAcceptProposal._atId) &&
        Objects.equals(this.forRelationship, presentProofAcceptProposal.forRelationship) &&
        Objects.equals(this.name, presentProofAcceptProposal.name) &&
        Objects.equals(this.revocationInterval, presentProofAcceptProposal.revocationInterval);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, forRelationship, name, revocationInterval);
  }
  ...
  public String toString() {
    ...
    sb.append("class PresentProofAcceptProposal {\n");
