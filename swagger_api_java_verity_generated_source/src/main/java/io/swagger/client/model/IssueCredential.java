...
import io.swagger.client.model.PleaseAck;
import io.swagger.v3.oas.annotations.media.Schema;
import java.io.IOException;
import java.util.UUID;
/**
 * You must provide the same threadId as received in ask-accept msg.
 */
@Schema(description = "You must provide the same threadId as received in ask-accept msg.")
...
public class IssueCredential implements OneOfbody1 {
  @SerializedName("@type")
  private String _atType = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/issue";
  ...
  @SerializedName("~please_ack")
  private PleaseAck pleaseAck = null;

  @SerializedName("revRegistryId")
  private String revRegistryId = null;

  @SerializedName("comment")
  private String comment = null;

  public IssueCredential _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/issue", required = true, description = "")
  ...
  public IssueCredential _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public IssueCredential forRelationship(String forRelationship) {
  ...
  **/
  ...
  public IssueCredential pleaseAck(PleaseAck pleaseAck) {
  ...
  **/
  @Schema(description = "")
  public PleaseAck getPleaseAck() {
    return pleaseAck;
  }

  public void setPleaseAck(PleaseAck pleaseAck) {
    this.pleaseAck = pleaseAck;
  }

  public IssueCredential revRegistryId(String revRegistryId) {
    this.revRegistryId = revRegistryId;
    return this;
  }

   /**
   * revocation registry id
   * @return revRegistryId
  **/
  @Schema(description = "revocation registry id")
  public String getRevRegistryId() {
    return revRegistryId;
  }

  public void setRevRegistryId(String revRegistryId) {
    this.revRegistryId = revRegistryId;
  }

  public IssueCredential comment(String comment) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IssueCredential issueCredential = (IssueCredential) o;
    return Objects.equals(this._atType, issueCredential._atType) &&
        Objects.equals(this._atId, issueCredential._atId) &&
        Objects.equals(this.forRelationship, issueCredential.forRelationship) &&
        Objects.equals(this.pleaseAck, issueCredential.pleaseAck) &&
        Objects.equals(this.revRegistryId, issueCredential.revRegistryId) &&
        Objects.equals(this.comment, issueCredential.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, forRelationship, pleaseAck, revRegistryId, comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCredential {\n");
    ...
    sb.append("    pleaseAck: ").append(toIndentedString(pleaseAck)).append("\n");
    sb.append("    revRegistryId: ").append(toIndentedString(revRegistryId)).append("\n");
