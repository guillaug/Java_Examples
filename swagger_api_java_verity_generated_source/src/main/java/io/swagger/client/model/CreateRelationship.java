...
public class CreateRelationship implements OneOfbody {
  @SerializedName("@type")
  private String _atType = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/create";
  ...
  public CreateRelationship _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:123456789abcdefghi1234;spec/relationship/1.0/create", required = true, description = "")
  ...
  public CreateRelationship _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public CreateRelationship label(String label) {
    this.label = label;
    return this;
  }

   /**
   * Inviter label, usually company name
   * @return label
  **/
  @Schema(example = "AcmeCorp", description = "Inviter label, usually company name")
  ...
  public CreateRelationship logoUrl(String logoUrl) {
    this.logoUrl = logoUrl;
    return this;
  }

   /**
   * URL of the Inviter logo
   * @return logoUrl
  **/
  @Schema(example = "http://example.com/logo.png", description = "URL of the Inviter logo")
  ...
  public CreateRelationship phoneNumber(String phoneNumber) {
   ...
   * @return phoneNumber
  **/
  @Schema(example = "13101234567", description = "Phone number in +international format")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    CreateRelationship createRelationship = (CreateRelationship) o;
    return Objects.equals(this._atType, createRelationship._atType) &&
        Objects.equals(this._atId, createRelationship._atId) &&
        Objects.equals(this.label, createRelationship.label) &&
        Objects.equals(this.logoUrl, createRelationship.logoUrl) &&
        Objects.equals(this.phoneNumber, createRelationship.phoneNumber);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, label, logoUrl, phoneNumber);
  }
  ...
  public String toString() {
    ...
    sb.append("class CreateRelationship {\n");
