...
import io.swagger.client.model.ConnectionMsg;
...
public class ConnRequestReceived {
  @SerializedName("@type")
  ...
  @SerializedName("conn")
  private ConnectionMsg conn = null;

  public ConnRequestReceived _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/connections/1.0/request-receive", required = true, description = "")
  ...
  public ConnRequestReceived _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public ConnRequestReceived thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public ConnRequestReceived conn(ConnectionMsg conn) {
    this.conn = conn;
    return this;
  }
  ...
  **/
  @Schema(required = true, description = "")
  public ConnectionMsg getConn() {
    return conn;
  }

  public void setConn(ConnectionMsg conn) {
    this.conn = conn;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ConnRequestReceived connRequestReceived = (ConnRequestReceived) o;
    return Objects.equals(this._atType, connRequestReceived._atType) &&
        Objects.equals(this._atId, connRequestReceived._atId) &&
        Objects.equals(this.thread, connRequestReceived.thread) &&
        Objects.equals(this.conn, connRequestReceived.conn);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread, conn);
  }
  ...
  public String toString() {
    ...
    sb.append("    conn: ").append(toIndentedString(conn)).append("\n");
    sb.append("}");
    return sb.toString();
  }
