...
/**
 * Confirmation that the &#x27;handshake-reuse message&#x27; was sent and that &#x27;handshake-reuse-accepted&#x27; was received. &#x27;~thread&#x27; contains &#x27;pthid&#x27; - the @id of the Out-of-Band invitation
 */
@Schema(description = "Confirmation that the 'handshake-reuse message' was sent and that 'handshake-reuse-accepted' was received. '~thread' contains 'pthid' - the @id of the Out-of-Band invitation")
...
public class RelationshipReused {
  @SerializedName("@type")
  ...
  public RelationshipReused _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/out-of-band/1.0/relationship-reused", description = "")
  ...
  public RelationshipReused _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public RelationshipReused thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RelationshipReused relationshipReused = (RelationshipReused) o;
    return Objects.equals(this._atType, relationshipReused._atType) &&
        Objects.equals(this._atId, relationshipReused._atId) &&
        Objects.equals(this.thread, relationshipReused.thread);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread);
  }
