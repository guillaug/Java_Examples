...
import io.swagger.client.model.ProposedProofAttr;
import io.swagger.client.model.ProposedProofPred;
...
public class ProofReviewProposal {
  @SerializedName("@type")
  ...
  private List<ProposedProofAttr> attributes = null;

  @SerializedName("predicates")
  private List<ProposedProofPred> predicates = null;

  @SerializedName("comment")
  private String comment = null;

  public ProofReviewProposal _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/review-proposal", description = "")
  ...
  public ProofReviewProposal _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public ProofReviewProposal thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public ProofReviewProposal attributes(List<ProposedProofAttr> attributes) {
    this.attributes = attributes;
    return this;
  }

  public ProofReviewProposal addAttributesItem(ProposedProofAttr attributesItem) {
    if (this.attributes == null) {
      this.attributes = new ArrayList<ProposedProofAttr>();
    }
   ...
   /**
   * array of proposed proof attributes
   * @return attributes
  **/
  @Schema(description = "array of proposed proof attributes")
  public List<ProposedProofAttr> getAttributes() {
    return attributes;
  }

  public void setAttributes(List<ProposedProofAttr> attributes) {
    this.attributes = attributes;
  }

  public ProofReviewProposal predicates(List<ProposedProofPred> predicates) {
    this.predicates = predicates;
    return this;
  }

  public ProofReviewProposal addPredicatesItem(ProposedProofPred predicatesItem) {
    if (this.predicates == null) {
      this.predicates = new ArrayList<ProposedProofPred>();
    }
   ...
   /**
   * array of proposed proof predicates
   * @return predicates
  **/
  @Schema(description = "array of proposed proof predicates")
  public List<ProposedProofPred> getPredicates() {
    return predicates;
  }

  public void setPredicates(List<ProposedProofPred> predicates) {
    this.predicates = predicates;
  }

  public ProofReviewProposal comment(String comment) {
    this.comment = comment;
    return this;
  }

   /**
   * Comment with proof proposal
   * @return comment
  **/
  @Schema(description = "Comment with proof proposal")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProofReviewProposal proofReviewProposal = (ProofReviewProposal) o;
    return Objects.equals(this._atType, proofReviewProposal._atType) &&
        Objects.equals(this._atId, proofReviewProposal._atId) &&
        Objects.equals(this.thread, proofReviewProposal.thread) &&
        Objects.equals(this.attributes, proofReviewProposal.attributes) &&
        Objects.equals(this.predicates, proofReviewProposal.predicates) &&
        Objects.equals(this.comment, proofReviewProposal.comment);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread, attributes, predicates, comment);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofReviewProposal {\n");
