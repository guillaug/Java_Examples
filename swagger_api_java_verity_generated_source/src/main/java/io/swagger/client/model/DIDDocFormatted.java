...
import io.swagger.client.model.PublicKeyFormatted;
import io.swagger.client.model.ServiceFormatted;
...
public class DIDDocFormatted {
  @SerializedName("@context")
  private String _atContext = null;

  @SerializedName("id")
  private String id = "did:example:123456789abcdefghi;indy";

  @SerializedName("publicKey")
  private List<PublicKeyFormatted> publicKey = new ArrayList<PublicKeyFormatted>();

  @SerializedName("service")
  private List<ServiceFormatted> service = new ArrayList<ServiceFormatted>();

  public DIDDocFormatted _atContext(String _atContext) {
   ...
   * @return _atContext
  **/
  @Schema(example = "https://w3id.org/did/v1", required = true, description = "")
  ...
  public DIDDocFormatted id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public DIDDocFormatted publicKey(List<PublicKeyFormatted> publicKey) {
    this.publicKey = publicKey;
    return this;
  }

  public DIDDocFormatted addPublicKeyItem(PublicKeyFormatted publicKeyItem) {
  ...
  **/
  ...
  public List<PublicKeyFormatted> getPublicKey() {
    return publicKey;
  }

  public void setPublicKey(List<PublicKeyFormatted> publicKey) {
    this.publicKey = publicKey;
  }

  public DIDDocFormatted service(List<ServiceFormatted> service) {
    this.service = service;
    return this;
  }

  public DIDDocFormatted addServiceItem(ServiceFormatted serviceItem) {
  ...
  **/
  @Schema(required = true, description = "")
  public List<ServiceFormatted> getService() {
    return service;
  }

  public void setService(List<ServiceFormatted> service) {
    this.service = service;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    DIDDocFormatted diDDocFormatted = (DIDDocFormatted) o;
    return Objects.equals(this._atContext, diDDocFormatted._atContext) &&
        Objects.equals(this.id, diDDocFormatted.id) &&
        Objects.equals(this.publicKey, diDDocFormatted.publicKey) &&
        Objects.equals(this.service, diDDocFormatted.service);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atContext, id, publicKey, service);
  }
  ...
  public String toString() {
    ...
    sb.append("class DIDDocFormatted {\n");
