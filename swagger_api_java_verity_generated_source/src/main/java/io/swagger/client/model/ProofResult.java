...
import io.swagger.client.model.RequestedProof;
...
public class ProofResult {
  ...
  @SerializedName("requested_presentation")
  private RequestedProof requestedPresentation = null;

  @SerializedName("verification_result")
  private String verificationResult = null;

  public ProofResult _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/presentation-result", description = "")
  ...
  public ProofResult _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public ProofResult thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public ProofResult requestedPresentation(RequestedProof requestedPresentation) {
  ...
  **/
  @Schema(description = "")
  public RequestedProof getRequestedPresentation() {
    return requestedPresentation;
  }

  public void setRequestedPresentation(RequestedProof requestedPresentation) {
    this.requestedPresentation = requestedPresentation;
  }

  public ProofResult verificationResult(String verificationResult) {
  ...
  **/
  @Schema(example = "ProofValidated", description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProofResult proofResult = (ProofResult) o;
    return Objects.equals(this._atType, proofResult._atType) &&
        Objects.equals(this._atId, proofResult._atId) &&
        Objects.equals(this.thread, proofResult.thread) &&
        Objects.equals(this.requestedPresentation, proofResult.requestedPresentation) &&
        Objects.equals(this.verificationResult, proofResult.verificationResult);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread, requestedPresentation, verificationResult);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofResult {\n");
    
    sb.append("    _atType: ").append(toIndentedString(_atType)).append("\n");
    sb.append("    _atId: ").append(toIndentedString(_atId)).append("\n");
    sb.append("    thread: ").append(toIndentedString(thread)).append("\n");
    sb.append("    requestedPresentation: ").append(toIndentedString(requestedPresentation)).append("\n");
