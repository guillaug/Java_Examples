...
public class IssueCredentialStatusReportResult {
  @SerializedName("@id")
  ...
  public IssueCredentialStatusReportResult _atId(String _atId) {
    this._atId = _atId;
    return this;
  }
   ...
   * @return _atId
  **/
  @Schema(example = "0729a580-2240-11e6-9eb5-0002a5d5cabc", description = "")
  ...
  public IssueCredentialStatusReportResult _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/status-report", description = "")
  ...
  public IssueCredentialStatusReportResult thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public IssueCredentialStatusReportResult status(String status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @Schema(example = "CredSent", description = "")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IssueCredentialStatusReportResult issueCredentialStatusReportResult = (IssueCredentialStatusReportResult) o;
    return Objects.equals(this._atId, issueCredentialStatusReportResult._atId) &&
        Objects.equals(this._atType, issueCredentialStatusReportResult._atType) &&
        Objects.equals(this.thread, issueCredentialStatusReportResult.thread) &&
        Objects.equals(this.status, issueCredentialStatusReportResult.status);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atId, _atType, thread, status);
  }
  ...
  public String toString() {
    ...
    sb.append("class IssueCredentialStatusReportResult {\n");
