...
public class ProofPredicate {
  ...
  public ProofPredicate name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(required = true, description = "name of predicate")
  ...
  public ProofPredicate pType(String pType) {
    this.pType = pType;
    return this;
  }
   ...
   * @return pType
  **/
  @Schema(required = true, description = "type of predicate")
  ...
  public ProofPredicate pValue(Integer pValue) {
    this.pValue = pValue;
    return this;
  }
   ...
   * @return pValue
  **/
  @Schema(required = true, description = "value of predicate")
  ...
  public ProofPredicate restrictions(List<Restriction> restrictions) {
    this.restrictions = restrictions;
    return this;
  }

  public ProofPredicate addRestrictionsItem(Restriction restrictionsItem) {
  ...
  **/
  ...
  public ProofPredicate nonRevoked(RevocationInterval nonRevoked) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProofPredicate proofPredicate = (ProofPredicate) o;
    return Objects.equals(this.name, proofPredicate.name) &&
        Objects.equals(this.pType, proofPredicate.pType) &&
        Objects.equals(this.pValue, proofPredicate.pValue) &&
        Objects.equals(this.restrictions, proofPredicate.restrictions) &&
        Objects.equals(this.nonRevoked, proofPredicate.nonRevoked);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, pType, pValue, restrictions, nonRevoked);
  }
