...
public class ProofAttr {
  ...
  private RevocationInterval nonRevoked = null;

  @SerializedName("self_attest_allowed")
  private Boolean selfAttestAllowed = null;

  public ProofAttr name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "license_num", description = "")
  ...
  public ProofAttr names(List<String> names) {
    this.names = names;
    return this;
  }

  public ProofAttr addNamesItem(String namesItem) {
    if (this.names == null) {
  ...
  **/
  ...
  public ProofAttr restrictions(List<Restriction> restrictions) {
    this.restrictions = restrictions;
    return this;
  }

  public ProofAttr addRestrictionsItem(Restriction restrictionsItem) {
  ...
  **/
  ...
  public ProofAttr nonRevoked(RevocationInterval nonRevoked) {
  ...
  **/
  @Schema(description = "")
  public RevocationInterval getNonRevoked() {
    return nonRevoked;
  }

  public void setNonRevoked(RevocationInterval nonRevoked) {
    this.nonRevoked = nonRevoked;
  }

  public ProofAttr selfAttestAllowed(Boolean selfAttestAllowed) {
    this.selfAttestAllowed = selfAttestAllowed;
    return this;
  }

   /**
   * Get selfAttestAllowed
   * @return selfAttestAllowed
  **/
  @Schema(description = "")
  public Boolean isSelfAttestAllowed() {
    return selfAttestAllowed;
  }

  public void setSelfAttestAllowed(Boolean selfAttestAllowed) {
    this.selfAttestAllowed = selfAttestAllowed;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    ProofAttr proofAttr = (ProofAttr) o;
    return Objects.equals(this.name, proofAttr.name) &&
        Objects.equals(this.names, proofAttr.names) &&
        Objects.equals(this.restrictions, proofAttr.restrictions) &&
        Objects.equals(this.nonRevoked, proofAttr.nonRevoked) &&
        Objects.equals(this.selfAttestAllowed, proofAttr.selfAttestAllowed);
  }

  @Override
  public int hashCode() {
    return Objects.hash(name, names, restrictions, nonRevoked, selfAttestAllowed);
  }
  ...
  public String toString() {
    ...
    sb.append("class ProofAttr {\n");
    
    sb.append("    name: ").append(toIndentedString(name)).append("\n");
    sb.append("    names: ").append(toIndentedString(names)).append("\n");
    sb.append("    restrictions: ").append(toIndentedString(restrictions)).append("\n");
    sb.append("    nonRevoked: ").append(toIndentedString(nonRevoked)).append("\n");
    sb.append("    selfAttestAllowed: ").append(toIndentedString(selfAttestAllowed)).append("\n");
    sb.append("}");
    return sb.toString();
  }
