...
public class PostResponse {
   ...
   * @return status
  **/
  @Schema(example = "Accepted", required = true, description = "")
  ...
  public PostResponse errorCode(String errorCode) {
   ...
   * @return errorCode
  **/
  @Schema(example = "GNR-101", description = "Present only if status is Error")
  ...
  public PostResponse errorDetails(String errorDetails) {
   ...
   * @return errorDetails
  **/
  @Schema(example = "Invalid protocol family and/or version", description = "Present only if status is Error")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.status, postResponse.status) &&
        Objects.equals(this.errorCode, postResponse.errorCode) &&
        Objects.equals(this.errorDetails, postResponse.errorDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(status, errorCode, errorDetails);
  }
