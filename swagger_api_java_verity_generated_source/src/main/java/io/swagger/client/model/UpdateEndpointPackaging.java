...
public class UpdateEndpointPackaging {
  /**
   * Gets or Sets pkgType
   */
  @JsonAdapter(PkgTypeEnum.Adapter.class)
  public enum PkgTypeEnum {
    ...
    public static PkgTypeEnum fromValue(String text) {
      for (PkgTypeEnum b : PkgTypeEnum.values()) {
    ...
    public static class Adapter extends TypeAdapter<PkgTypeEnum> {
      @Override
      public void write(final JsonWriter jsonWriter, final PkgTypeEnum enumeration) throws IOException {
        jsonWriter.value(enumeration.getValue());
      }

      @Override
      public PkgTypeEnum read(final JsonReader jsonReader) throws IOException {
        String value = jsonReader.nextString();
        return PkgTypeEnum.fromValue(String.valueOf(value));
      }
    }
  }  @SerializedName("pkgType")
  private PkgTypeEnum pkgType = PkgTypeEnum.PLAIN;

  public UpdateEndpointPackaging pkgType(PkgTypeEnum pkgType) {
  ...
  **/
  @Schema(description = "")
  public PkgTypeEnum getPkgType() {
    return pkgType;
  }

  public void setPkgType(PkgTypeEnum pkgType) {
    this.pkgType = pkgType;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateEndpointPackaging updateEndpointPackaging = (UpdateEndpointPackaging) o;
    return Objects.equals(this.pkgType, updateEndpointPackaging.pkgType);
  }

  @Override
  public int hashCode() {
    return Objects.hash(pkgType);
  }
