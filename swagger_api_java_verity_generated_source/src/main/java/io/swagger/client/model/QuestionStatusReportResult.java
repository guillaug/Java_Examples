...
import io.swagger.client.model.AnswerData;
...
public class QuestionStatusReportResult {
  @SerializedName("@type")
  ...
  private AnswerData answer = null;

  public QuestionStatusReportResult _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/committedanswer/1.0/status-report", description = "")
  ...
  public QuestionStatusReportResult thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public QuestionStatusReportResult status(String status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @Schema(example = "AnswerReceived", description = "")
  ...
  public QuestionStatusReportResult answer(AnswerData answer) {
    this.answer = answer;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    QuestionStatusReportResult questionStatusReportResult = (QuestionStatusReportResult) o;
    return Objects.equals(this._atType, questionStatusReportResult._atType) &&
        Objects.equals(this.thread, questionStatusReportResult.thread) &&
        Objects.equals(this.status, questionStatusReportResult.status) &&
        Objects.equals(this.answer, questionStatusReportResult.answer);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, thread, status, answer);
  }
  ...
  public String toString() {
    ...
    sb.append("class QuestionStatusReportResult {\n");
