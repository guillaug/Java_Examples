...
import io.swagger.client.model.AskAcceptRequest;
...
public class AskAccept {
  ...
  private AskAcceptRequest request = null;

  public AskAccept _atType_(String _atType_) {
   ...
   * @return _atType_
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/issue-credential/1.0/accept-request", description = "")
  ...
  public AskAccept _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public AskAccept thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public AskAccept request(AskAcceptRequest request) {
  ...
  **/
  @Schema(description = "")
  public AskAcceptRequest getRequest() {
    return request;
  }

  public void setRequest(AskAcceptRequest request) {
    this.request = request;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    AskAccept askAccept = (AskAccept) o;
    return Objects.equals(this._atType_, askAccept._atType_) &&
        Objects.equals(this._atId, askAccept._atId) &&
        Objects.equals(this.thread, askAccept.thread) &&
        Objects.equals(this.request, askAccept.request);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType_, _atId, thread, request);
  }
