...
public class UpdateConfigsRequest {
  @SerializedName("@type")
  private String _atType = "did:sov:123456789abcdefghi1234;spec/update-configs/0.6/update";

  @SerializedName("@id")
  private UUID _atId = null;

  @SerializedName("configs")
  private List<ConfigDetail> configs = new ArrayList<ConfigDetail>();

  public UpdateConfigsRequest _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:123456789abcdefghi1234;spec/update-configs/0.6/update", required = true, description = "")
  ...
  public UpdateConfigsRequest _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public UpdateConfigsRequest configs(List<ConfigDetail> configs) {
    this.configs = configs;
    return this;
  }

  public UpdateConfigsRequest addConfigsItem(ConfigDetail configsItem) {
   ...
   * @return configs
  **/
  @Schema(example = "[{\"name\":\"name\",\"value\":\"AcmeCorp\"},{\"name\":\"logoUrl\",\"value\":\"http://example.com/logo.png\"}]", required = true, description = "")
  public List<ConfigDetail> getConfigs() {
    return configs;
  }

  public void setConfigs(List<ConfigDetail> configs) {
    this.configs = configs;
  }
  ...
  public boolean equals(java.lang.Object o) {
    ...
    UpdateConfigsRequest updateConfigsRequest = (UpdateConfigsRequest) o;
    return Objects.equals(this._atType, updateConfigsRequest._atType) &&
        Objects.equals(this._atId, updateConfigsRequest._atId) &&
        Objects.equals(this.configs, updateConfigsRequest.configs);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, configs);
  }
  ...
  public String toString() {
    ...
    sb.append("class UpdateConfigsRequest {\n");
