...
public class IssueCredentialInvite {
  @SerializedName("@type")
  ...
  @SerializedName("shortInviteURL")
  private String shortInviteURL = null;

  @SerializedName("invitationId")
  private UUID invitationId = null;

  public IssueCredentialInvite _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:BzCbsNYhMrjHiqZDTUASHg;spec/present-proof/1.0/protocol-invitation", required = true, description = "")
  ...
  public IssueCredentialInvite _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public IssueCredentialInvite thread(Thread thread) {
    this.thread = thread;
    return this;
  }
  ...
  **/
  ...
  public IssueCredentialInvite inviteURL(String inviteURL) {
   ...
   * @return inviteURL
  **/
  @Schema(required = true, description = "Invite URL which should be sent to invited party.")
  ...
  public IssueCredentialInvite shortInviteURL(String shortInviteURL) {
   ...
   * @return shortInviteURL
  **/
  @Schema(example = "https://vty.im/abcde", description = "Short invite URL which should be sent to invited party.")
  public String getShortInviteURL() {
    return shortInviteURL;
  }

  public void setShortInviteURL(String shortInviteURL) {
    this.shortInviteURL = shortInviteURL;
  }

  public IssueCredentialInvite invitationId(UUID invitationId) {
   ...
   * @return invitationId
  **/
  @Schema(example = "f59bc8e5-cf37-4041-b2c2-d472c1ea2cd4", description = "id of invitation")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    IssueCredentialInvite issueCredentialInvite = (IssueCredentialInvite) o;
    return Objects.equals(this._atType, issueCredentialInvite._atType) &&
        Objects.equals(this._atId, issueCredentialInvite._atId) &&
        Objects.equals(this.thread, issueCredentialInvite.thread) &&
        Objects.equals(this.inviteURL, issueCredentialInvite.inviteURL) &&
        Objects.equals(this.shortInviteURL, issueCredentialInvite.shortInviteURL) &&
        Objects.equals(this.invitationId, issueCredentialInvite.invitationId);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, thread, inviteURL, shortInviteURL, invitationId);
  }
  ...
  public String toString() {
    ...
    sb.append("    shortInviteURL: ").append(toIndentedString(shortInviteURL)).append("\n");
