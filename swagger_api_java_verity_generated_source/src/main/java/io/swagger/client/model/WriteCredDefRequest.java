...
import io.swagger.client.model.RevocationDetails;
...
public class WriteCredDefRequest {
  @SerializedName("@type")
  private String _atType = "did:sov:123456789abcdefghi1234;spec/write-cred-def/0.6/write";
  ...
  @SerializedName("revocationDetails")
  private RevocationDetails revocationDetails = null;

  public WriteCredDefRequest _atType(String _atType) {
   ...
   * @return _atType
  **/
  @Schema(example = "did:sov:123456789abcdefghi1234;spec/write-cred-def/0.6/write", description = "")
  ...
  public WriteCredDefRequest _atId(UUID _atId) {
    this._atId = _atId;
    return this;
  }
  ...
  **/
  ...
  public WriteCredDefRequest name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @Schema(example = "cred_name1", description = "name of cred def")
  ...
  public WriteCredDefRequest tag(String tag) {
    this.tag = tag;
    return this;
  }
   ...
   * @return tag
  **/
  @Schema(example = "tag", description = "")
  ...
  public WriteCredDefRequest schemaId(String schemaId) {
   ...
   * @return schemaId
  **/
  @Schema(example = "39YBdt6BLWLJAUPA8NvwDX:2:license:0.1", description = "schema id of schema to be used")
  ...
  public WriteCredDefRequest revocationDetails(RevocationDetails revocationDetails) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    WriteCredDefRequest writeCredDefRequest = (WriteCredDefRequest) o;
    return Objects.equals(this._atType, writeCredDefRequest._atType) &&
        Objects.equals(this._atId, writeCredDefRequest._atId) &&
        Objects.equals(this.name, writeCredDefRequest.name) &&
        Objects.equals(this.tag, writeCredDefRequest.tag) &&
        Objects.equals(this.schemaId, writeCredDefRequest.schemaId) &&
        Objects.equals(this.revocationDetails, writeCredDefRequest.revocationDetails);
  }

  @Override
  public int hashCode() {
    return Objects.hash(_atType, _atId, name, tag, schemaId, revocationDetails);
  }
